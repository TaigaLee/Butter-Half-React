  ...
  render() {
    return (
      <div className="light">
        ...
        {/* </div> */}
        <div
          style={{ paddingTop: "50px", textAlign: "center", display: "flex" }}
        >
            ...
            >
              <div className="userSelector">
                <Avatar
                  ...
                  style={{ margin: "auto", width: "10%", marginTop: " 13px" }}
                ></Avatar>
                <p style={{ margin: "auto" }}>
                  <a onClick={() => this.login("superhero1")} href="#">
                    {" "}
                    superhero1
                  </a>
                </p>
              ...
              <div className="userSelector">
                ...
                ></Avatar>
                <p style={{ margin: "auto" }}>
                  <a onClick={() => this.login("superhero2")} href="/#">
                    {" "}
                    superhero2
                  </a>
                </p>
              ...
              <div className="userSelector">
                ...
                ></Avatar>
                <p style={{ margin: "auto" }}>
                  <a onClick={() => this.login("superhero3")} href="/#">
                    {" "}
                    superhero3
                  </a>
                </p>
              ...
              <div className="userSelector">
                ...
                ></Avatar>
                <p style={{ margin: "auto" }}>
                  <a onClick={() => this.login("superhero4")} href="/#">
                    {" "}
                    superhero4
                  </a>
                </p>
              ...
              <div className="userSelector">
                ...
                ></Avatar>
                <p style={{ margin: "auto" }}>
                  <a onClick={() => this.login("superhero5")} href="/#">
                    {" "}
                    superhero5
                  </a>
                </p>
