      ...
      <div className="cp-navbar">
        ...
        <div className="tab">
          <button onClick={() => this.onTabChange("contacts")}>
            <img
              src={
                this.state.activeTab === "contacts" ? peopleBlue : peopleGrey
              }
              alt="contacts"
            />
          </button>
          <button
            style={{ display: "none" }}
            onClick={() => this.onTabChange("calls")}
          >
            <img
              src={this.state.activeTab === "calls" ? callBlue : callGrey}
              alt="calls"
            />
          </button>
          <button onClick={() => this.onTabChange("conversations")}>
            <img
              src={
                this.state.activeTab === "conversations" ? chatBlue : chatGrey
              }
              alt="conversations"
            />
          </button>
          <button onClick={() => this.onTabChange("groups")}>
            <img
              src={this.state.activeTab === "groups" ? groupBlue : groupGrey}
              alt="groups"
            />
          </button>
        </div>
